...
> Esta carpeta se llamaba `modulo05-cashflow`; se renombró para no chocar con el M05 del cliente.

# M5 — Cashflow (Catálogos, Ingesta y Movimientos)

Índice del módulo. La info canónica vive en `context/contratos/specs/` y `context/contratos/db/` (referenciados por el harness); acá se enlaza + se resume el modelo del resultado de cartola.

## Contexto — fuentes

| Tema | Fuente |
|---|---|
| Arquitectura y flujo de extracción de cartolas (Kread, reglas, V1/V2) | [`../../contratos/specs/cartola-extraction.md`](../../contratos/specs/cartola-extraction.md) |
| Spec de cashflow (movimientos, catálogos) | [`../../contratos/specs/cashflow.md`](../../contratos/specs/cashflow.md) |
| Schema / DB (Layers 7 Catálogos · 8 Ingesta · 9 Movimientos) | [`../../contratos/db/modulo5.md`](../../contratos/db/modulo5.md) |
